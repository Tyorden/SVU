...
> **Correction (July 5, 2026):** Point 4 counts the `wrong_ID` *tag*, which marks any misidentification element in a case. The controlled `accusation_origin` *field* tells a different story: `squad_inference` (detectives' own theories) is the leading origin at 54.5% of qualifying persons; most wrong_ID tags sit on squad_inference-origin rows. Later keyword-level claims derived from `consequence_detail` (e.g., death counts) were also found to be inflated by keyword matching. The verified, publication-grade statistics live in `docs/svu_paper_stats_v2.md`, which supersedes the results tables in this document wherever they disagree.
>
> **Source-corruption finding (July 5, 2026):** A ground-truth audit against the original transcript Excel found two defects this documentation did not know about. (1) **Nine episodes carry the wrong transcript** — a duplicate of another episode's script: S01E13 (contains S01E15), S02E11 (S02E10), S02E18 (S02E19), S04E10 (S04E23), S05E04 (S06E14), S05E14 (S12E10), S08E11 (S18E08), S09E19 (S26E19), S11E09 (S26E08). These created 15 phantom person-rows, removed in the corrected analysis set (n=521). (2) **145 of 576 transcripts (25.2%) are truncated at exactly 32,767 characters** — the Excel cell limit — 138 of them in Seasons 1-18, meaning a third of early-era episodes are missing their final acts. The "Data Quality Notes" above (5 defective episodes) therefore undercounts: the true figure is 14 defective episodes plus 145 truncated. A re-run from non-Excel transcript sources would fix both.
