...
## ADDENDUM (2026-09-04 23:33 PDT): blind AI-AI re-coding reliability study (does not change any number above)

Source: docs/VALIDATION_RESULTS_2026-09-04.md; pre-registration docs/VALIDATION_ANCHORS_2026-09-04.md; code and data docs/validation_2026-09-04/ (verify: `cd docs/validation_2026-09-04 && python3 agreement.py`). Second coder: Claude Fable 5.1 (subagent #162), blind to the original codes, fresh protocol restating the documented codebook; sample 90 episodes (60 SVU + 30 L&O), seed 20260904; B = 2000 cluster bootstrap over episodes. This is repeatability across two AI coders, not a human validation and not a truth check.

**SVU-only (60 episodes; 35 matched persons).** Episode level: has_false_suspect 73.3% agreement, kappa 0.467 [0.267, 0.662]; has_public_exposure 73.3%, kappa 0.470 [0.241, 0.694]; needs_deep_review 91.7%, kappa 0 (original flagged none). Person inclusion: original 59 vs re-coded 51 persons, 35 matched, Jaccard 0.467 [0.337, 0.600]; per-episode count exact 60.0%, within one 88.3%. Person level: innocence_status kappa 0.134; role_in_plot 0.197; accused_of 0.178; accusation_origin 0.446 [0.230, 0.678]; exposure_channel 0.477 [0.290, 0.660]; exposure_who_told 0.096; consequence_category 0.455 [0.232, 0.678]; consequence_severity 0.381 unweighted, 0.509 [0.265, 0.705] linear-weighted; police_conduct_threat 0.271 [0.068, 0.476]; police_apology 0.327; screen_evidence 0.278; confidence 0 (original always high). Derived binaries: any_threat 0.370 [0.088, 0.653]; any_apology 0.718 [0, 1]; severe (3-4) 0.469 [0.108, 0.753]; media_or_online 0.624 [0, 1]; beyond_police_only 0.146.

**Pooled (90 episodes; 52 matched persons).** has_false_suspect kappa 0.471 [0.312, 0.627]; has_public_exposure 0.495 [0.321, 0.664]; Jaccard 0.456 [0.364, 0.561]; accusation_origin 0.411; exposure_channel 0.368; consequence_severity weighted 0.457 [0.251, 0.623]; police_conduct_threat 0.204; any_threat 0.280; severe 0.451; L&O prosecutorial_conduct 0.422 (n = 17).

**Decision rule (pre-registered, kappa < 0.61 named in Limitations):** both episode flags and every raw person-level field fall below 0.61 in the SVU set; only the rare-event derived binaries any_apology and media_or_online exceed it, with CIs reaching 0. Episode-level presence of a false-suspect plot is moderately reliable across coders; the person-level record is not field-reliable; the person census differs by about half its rows between coders (six systematic sources listed in VALIDATION_RESULTS section 5: inclusion threshold for harmless police-only clearances, the partially_involved boundary, role/accused_of/channel label conventions incl. the original's out-of-vocabulary "multiple" and "legal" channels, confidence calibration, two-accusation rows, series-regular scoping).

**New source-quality finding:** svu_s07_e15 ("Manipulated") carries the S10E07 ("Wildlife") transcript byte-for-byte (a tenth wrong-transcript episode). If adopted, the primary episode denominator becomes **566** (pre-era 400) and no person row is removed (the original S07E15 record has none; its N/N flags describe the wrong episode). Not applied above; recorded for Tyler's decision.

**Contested formal-apology rows (bear on the "8 formal apologies" figure, A8):** Frank Sullivan S11E21 (original formal; re-coder found none on the page) and Mark Dobbins S06E11 (re-coder formal, quoted "I'm sorry" plus court apology; original none). Also formal-vs-partial splits for Vega S05E21, Lomatin S14E05, Shea S14E10. Settle by human read before citing the count again. Direct factual disagreements for a third read: Paul Davies S21E20 (original falsely accused vs re-coder guilty), Jackie Madden S05E25.

**Coverage caveat:** the contamination exclusion removed most of the 32 death rows and the 8 formal-apology rows from the sampling frame, so this study does not speak to those priority strata.
